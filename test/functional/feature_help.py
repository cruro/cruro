...
"""Verify that starting Cruro with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Cruro with -h for help text")
        ...
        self.log.info("Start Cruro with -version for version information")
