Contributing to Cruro Core
============================

The Cruro Core project operates an open contributor model where anyone is
...
Most communication about Cruro Core development happens on IRC, in the
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the Cruro unit tests or QA tests
...
The following applies to code changes to the Cruro Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitcoin
Network Protocol consensus changes.

Whether a pull request is merged into Cruro Core rests with the project merge
...
Patches that change Cruro consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cruro consensus, it must have been
...
The project leader is the release manager for each Cruro Core release.
