...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated Cruro to."},
            ...
            + "If you are running the Cruro core wallet, you can get a new address to send the newly generated Cruro to with:\n"
...
// NOTE: Unlike wallet RPC (which use CRC values), mining RPCs follow GBT (BIP 22) in using crury amounts
