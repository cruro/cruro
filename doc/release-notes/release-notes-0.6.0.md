...
NEW FEATURES SINCE Cruro VERSION 0.5
...
own a Cruro address by creating a digital
signature.
...
will be accepted by the Cruro network.
...
transactions is limited to the Cruro test network using
