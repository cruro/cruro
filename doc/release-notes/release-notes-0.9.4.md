...
this update is incompatible with the Cruro system and could lead to consensus
forks.
...
- A third-party or self-compiled Cruro Core

upgrade to Cruro Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
