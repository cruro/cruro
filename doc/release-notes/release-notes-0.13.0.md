...
Various code modernizations have been done. The Cruro Core code base has
...
HD wallets are incompatible with older versions of Cruro Core.
...
proposed parameters, a future release of Cruro Core is expected that
...
- #7636 `fb0ac48` Add Cruro address label to request payment QR code (makevoid)
