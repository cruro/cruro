# PSBT Howto for Cruro Core

Since Cruro Core 0.17, an RPC interface exists for Partially Signed Bitcoin
...
PSBT is an interchange format for Cruro transactions that are not fully signed
...
#### Multisig with multiple Cruro Core instances
...
Later, when *V* CRC has been received on *Amulti*, and Bob and Carol want to
