# Support for Output Descriptors in Cruro Core

Since Cruro Core v0.17, there is support for Output Descriptors. This is a
...
existing Cruro Core wallets, a convenience function `combo` is
...
All RPCs in Cruro Core will include the checksum in their output. Only
